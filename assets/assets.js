...
export const categories = ["Necklace", "Earings", "Bracelets", "Rings", "Anklets", "Keychains"];
...
export const ourSpecsData = [
    { title: "Free Shipping", description: "Enjoy fast, free delivery on every order above ₹99 no conditions, just reliable doorstep.", icon: SendIcon, accent: '#05DF72' },
    { title: "3 Days easy Return", description: "Change your mind? No worries. Return any item within 7 days.", icon: ClockFadingIcon, accent: '#FF8904' },
